...
object SumaReactiva extends App {
  ...
  val suma: Signal[Int] = Signal { calificaciones.value.sum }

  val observador = suma.changed.observe { nuevoValor =>
    println(s"Suma actual = $nuevoValor")
  }
...
<img width="371" height="124" alt="image" src="https://github.com/user-attachments/assets/b59cb4be-a441-4137-8830-9802669d2d7c" />
...
object EnergiaCineticaReactiva extends App {
  val masa = Var(1000.0)
  ...
  val observador = energiaCinetica.changed.observe { e =>
...
<img width="580" height="162" alt="image" src="https://github.com/user-attachments/assets/c00adae7-4573-4322-90ed-055d92e853c1" />
